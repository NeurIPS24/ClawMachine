...
class D_CLIPVisionTower(nn.Module):
    def __init__(self, vision_tower, args, delay_load=False):
        ...
        self.image_processor = CLIPImageProcessor.from_pretrained('/home/Clawmachine/clip-vit-large-patch14')
        self.select_layer = args.mm_vision_select_layer # wont be used now
        self.select_feature = getattr(args, 'mm_vision_select_feature', 'patch')

        self.config = torch.load('/home/Clawmachine/clipconfig')
    ...
    #     self.is_loaded = True
    def load_model(self, model_path='/home/Clawmachine/LaVIT-7B-v2', model_dtype='bf16', device_id=None,**kwargs):
        if self.is_loaded:
        ...
        # NOT SETTLED
        # self.image_processor = CLIPImageProcessor.from_pretrained(self.vision_tower_name)
        self.vision_tower = VQClip(model_path='/home/Clawmachine/LaVIT-7B-v2', model_dtype=model_dtype, device_id=device_id, use_xformers=False)
